...
public class EmpruntDaoTestCase {
    ...
    public void initDb() throws Exception {
        try (Connection connection = DataSourceProvider.getDataSource().getConnection();
            ...
            stmt.executeUpdate("INSERT INTO etudiant(`etudiant_id`, `statut_id`, `etudiant_nom`, `prenom`, `mdp`, `telephone`, `mail`, `verifie`, `mdp_verification`) VALUES (1,2,'SAMANOS', 'Mathilde', 'azertyazertyazertyazertyazertyazertyazertyazertyazertyazertyazertyazertyazertyazertyazertyazerty','0648745614','mathilde.samanos@hei.yncrea.fr', 'true', 'zf4f5*-dsdzf4f5*-dsdzf4f5*-dsdzf4f5*-dsdzf4f5*-dsd');");
            stmt.executeUpdate("INSERT INTO etudiant(`etudiant_id`, `statut_id`, `etudiant_nom`, `prenom`, `mdp`, `telephone`, `mail`, `verifie`, `mdp_verification`) VALUES (2,1,'DEMORY', 'Thibaut', 'titidedetitidedetitidedetitidedetitidedetitidedetitidedetitidedetitidedetitidedetitidedetitidede','0648748448','thibaut.demory@hei.yncrea.fr', 'true', 'fzej\"àfld3fzej\"àfld3fzej\"àfld3fzej\"àfld3fzej\"àfld3');");
            stmt.executeUpdate("INSERT INTO etudiant(`etudiant_id`, `statut_id`, `etudiant_nom`, `prenom`, `mdp`, `telephone`, `mail`, `verifie`, `mdp_verification`) VALUES (3,3,'EVRARD', 'William', 'aeiouyaeiouyaeiouyaeiouyaeiouyaeiouyaeiouyaeiouyaeiouyaeiouyaeiouyaeiouyaeiouyaeiouyaeiouyaeiouy','0632847958','william.evrard@hei.yncrea.fr', 'true', 'lff0çfezzelff0çfezzelff0çfezzelff0çfezzelff0çfezze');");
    ...
    public void shouldListEmpruntByAssociation() throws Exception {
        ...
        assertThat(listEmprunt).extracting("id",
                ...
                tuple(1,
                        ...
                        1, "Responsable",
                        true, "fzej\"àfld3fzej\"àfld3fzej\"àfld3fzej\"àfld3fzej\"àfld3",
                ...
                tuple(2,
                        ...
                        2, "Sous-Responsable",
                        true, "zf4f5*-dsdzf4f5*-dsdzf4f5*-dsdzf4f5*-dsdzf4f5*-dsd",
                        2, "Crampons foot", 11, 31.0,
                        1, "Garage Jules Lefevre",
                        2, "Foot Feminin",
                        2, "DEMORY", "Thibaut", "titidedetitidedetitidedetitidedetitidedetitidedetitidedetitidedetitidedetitidedetitidedetitidede", "0648748448", "thibaut.demory@hei.yncrea.fr",
    ...
    public void shouldGetEmpruntById() throws Exception {
        ...
        assertThat(emprunt.getEtudiant().getMotDePasseVerification()).isEqualTo("fzej\"àfld3fzej\"àfld3fzej\"àfld3fzej\"àfld3fzej\"àfld3");
        ...
        assertThat(emprunt.getMateriel().getAssociation().getEtudiant().getMotDePasseVerification()).isEqualTo("fzej\"àfld3fzej\"àfld3fzej\"àfld3fzej\"àfld3fzej\"àfld3");
    ...
    public void shouldUpdateEmprunt() throws Exception {
        ...
        assertThat(modifiedEmprunt.getEtudiant().getMotDePasseVerification()).isEqualTo("fzej\"àfld3fzej\"àfld3fzej\"àfld3fzej\"àfld3fzej\"àfld3");
        ...
        assertThat(modifiedEmprunt.getMateriel().getAssociation().getEtudiant().getMotDePasseVerification()).isEqualTo("fzej\"àfld3fzej\"àfld3fzej\"àfld3fzej\"àfld3fzej\"àfld3");
    ...
    public void shouldAddEmprunt() throws Exception {
        ...
        assertThat(addedEmprunt.getEtudiant().getMotDePasseVerification()).isEqualTo("fzej\"àfld3fzej\"àfld3fzej\"àfld3fzej\"àfld3fzej\"àfld3");
        ...
        assertThat(addedEmprunt.getMateriel().getAssociation().getEtudiant().getMotDePasseVerification()).isEqualTo("fzej\"àfld3fzej\"àfld3fzej\"àfld3fzej\"àfld3fzej\"àfld3");
