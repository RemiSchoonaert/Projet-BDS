...
public class GererDaoTestCase {
    ...
    public void initDb() throws Exception {
        try (Connection connection = DataSourceProvider.getDataSource().getConnection();
            ...
            stmt.executeUpdate("INSERT INTO etudiant(`etudiant_id`, `statut_id`, `etudiant_nom`, `prenom`, `mdp`, `telephone`, `mail`, `verifie`, `mdp_verification`) VALUES (3,2,'EVRARD', 'William', 'aeiouyaeiouyaeiouyaeiouyaeiouyaeiouyaeiouyaeiouyaeiouyaeiouyaeiouyaeiouyaeiouyaeiouyaeiouyaeiouy','0632847958','william.evrard@hei.yncrea.fr', 'true', 'lff0çfezzelff0çfezzelff0çfezzelff0çfezzelff0çfezze');");
